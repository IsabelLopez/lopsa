...
- Las fotos externas se identifican como referencia. La foto de estacionamientos es de [Claudio Schwarz / Unsplash](https://unsplash.com/photos/empty-white-concrete-pillared-parking-lot-fAmj2spOqxc), bajo la [licencia Unsplash](https://unsplash.com/license); no representa una obra de LOPSA.
